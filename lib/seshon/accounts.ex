defmodule Seshon.Accounts do
  ...
  alias Seshon.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Seshon.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Seshon.Accounts.User.password_changeset/3` for a list of supported options.
